...
public class SimpleSortTest {
    ...
    public SimpleSortTest(int[] input, int[] expected) {
        this.input = input;
    ...
    public void bubbleSort() throws Exception {
        SimpleSort.BubbleSort(input, input.length);
    ...
    public void insertSort() throws Exception {
        SimpleSort.InsertSort(input, input.length);
        for (int i = 0; i < expected.length; i++) {
            Assert.assertEquals(expected[i], input[i]);
        }
    }
    ...
    public void selectSort() throws Exception {
        SimpleSort.SelectSort(input, input.length);
        for (int i = 0; i < expected.length; i++) {
            Assert.assertEquals(expected[i], input[i]);
        }
    }
